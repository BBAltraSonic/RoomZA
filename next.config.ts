...
const securityHeaders = [
  {
    ...
    value: [
      ...
      `connect-src 'self' https://*.supabase.co wss://*.supabase.co${localSupabaseHttpSources}${localSupabaseWebSocketSources} https://*.googleapis.com https://*.gstatic.com https://challenges.cloudflare.com https://*.ingest.sentry.io`,
      "worker-src blob:",
