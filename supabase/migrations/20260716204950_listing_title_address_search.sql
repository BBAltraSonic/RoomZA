-- Issue 2: committed discovery searches filter published listings by their
-- public title or address while remaining bounded to the active map viewport.
...
comment on function public.get_published_listings_in_bbox_with_query(
  double precision, double precision, double precision, double precision,
  text, integer, integer, integer, integer, text, public.listing_type
) is 'Bounded public discovery projection with literal title/address search and safe public trust signals.';
