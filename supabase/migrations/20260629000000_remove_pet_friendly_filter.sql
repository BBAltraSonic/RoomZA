-- Remove the pet-friendly filter from the viewport listings query.
-- Drops the previous signature (which carried pet_friendly_filter) and
-- recreates the function without it.

drop function if exists public.get_published_listings_in_bbox_with_query(double precision, double precision, double precision, double precision, text, integer, integer, integer, integer, text, boolean);
...
revoke execute on function public.get_published_listings_in_bbox_with_query(double precision, double precision, double precision, double precision, text, integer, integer, integer, integer, text) from public;
