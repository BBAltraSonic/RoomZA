...
const items: AdminNavItem[] = [
  ...
  { href: "/admin/trust", label: "Trust content", icon: FileCheck2 },
  { href: "/admin/privacy-requests", label: "Privacy requests", icon: LockKeyhole },
  { href: "/admin/verifications", label: "Verifications", icon: ShieldCheck },
  { href: "/admin/transparency", label: "Transparency", icon: Gauge },
